...
namespace TerrorbornMod.Items.Weapons.Ranged.Thrown
{
    ...
    {
        public override string Texture => "TerrorbornMod/Items/Weapons/Ranged/Thrown/ThrowingStar";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (timeUntilFall > 0)
            {
                ...
                for (int i = 0; i < Projectile.oldPos.Length; i++)
                {
                    ...
                    Color color = Projectile.GetAlpha(Color.LightSkyBlue) * ((Projectile.oldPos.Length - i) / (float)Projectile.oldPos.Length);
                    Graphics.DrawGlow_1(Main.spriteBatch, drawPos, (int)(45f * ((Projectile.oldPos.Length - i) / (float)Projectile.oldPos.Length)), color * 0.5f);
                }
            }
            return true;
        }
