    ...
    public class MartianBoosters : ModItem
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            if (player.controlDown)
            {
                if (downCounter == 0)
                {
                    ...
                    SoundExtensions.PlaySoundOld(SoundID.Item, (int)player.Center.X, (int)player.Center.Y, 72, 1.5f, -0.6f);
                }
                else
                {
                    downCounter--;
        ...
        public override void UpdateVanity(Player player)
        {
            ...
            if (player.controlJump && player.wingTime > 0 && player.velocity.Y != 0)
            {
                ...
                {
                    soundDelay = 10;
                    SoundExtensions.PlaySoundOld(SoundID.Item, (int)player.Center.X, (int)player.Center.Y, 24, 1, 1);
                }
