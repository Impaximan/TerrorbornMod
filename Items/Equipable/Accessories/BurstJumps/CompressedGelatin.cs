...
namespace TerrorbornMod.Items.Equipable.Accessories.BurstJumps
{
    class CompressedGelatin : ModItem
    {
        ...
        {
            Tooltip.SetDefault(TerrorbornUtils.GetBurstJumpString(60 * 2));
        }
        ...
        {
            TerrorbornUtils.UpdateBurstJump(60 * 2, 60 * 1, item, player, new Vector2(15, -15), Color.LightBlue, SoundID.Item14);
