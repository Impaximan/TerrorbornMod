...
namespace TerrorbornMod.Items.Ammo
{
    class FlamingDart : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<FlamingDartProjectile>();
    ...
    class FlamingDartProjectile : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                Item.NewItem(Projectile.GetItemSource_DropAsItem(), (int)Projectile.position.X, (int)Projectile.position.Y, Projectile.width, Projectile.height, ModContent.ItemType<FlamingDart>());
            }
