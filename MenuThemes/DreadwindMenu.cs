...
{
    class DreadwindMenu : ModMenu
    {
        public override Asset<Texture2D> Logo => ModContent.Request<Texture2D>("TerrorbornMod/MenuLogo");

        public override int Music => MusicLoader.GetMusicSlot("TerrorbornMod/Sounds/Music/FallOfTheArchangel_Piano");

        public override string DisplayName => "Terrorborn : Fall of the Archangel";

        public override ModSurfaceBackgroundStyle MenuBackgroundStyle => ModContent.GetInstance<DreadwindMenuSurfaceBGStyle>();
    }

    class DreadwindMenuSurfaceBGStyle : ModSurfaceBackgroundStyle
    {
