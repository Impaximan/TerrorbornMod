    ...
    class TerrorMeterUI : UIState
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            else
            {
                ...
                spriteBatch.Draw(texture, position - new Vector2(texture.Width / 2, texture.Height / 2) * Main.UIScale, texture.Bounds, Color.White, 0f, Vector2.Zero, scale, SpriteEffects.None, 0f);
                ...
                spriteBatch.Draw(texture, position + new Vector2(0, (int)(meterTop * scale)) - new Vector2(texture.Width / 2, texture.Height / 2) * Main.UIScale, new Rectangle(0, meterTop, texture.Width, texture.Height - meterTop), Color.White, 0f, Vector2.Zero, scale, SpriteEffects.None, 0f);
                ...
                spriteBatch.Draw(texture, position + new Vector2(0, (int)(meterTop * scale)) - new Vector2(width / 2, height / 2) * Main.UIScale, new Rectangle(0, meterTop + (height * frame), width, height - meterTop), Color.White, 0f, Vector2.Zero, scale, SpriteEffects.None, 0f);
                ...
                spriteBatch.DrawString(Main.fontDeathText, meterText, position, Color.FromNonPremultiplied(209, 233, 246, 255), 0f, Vector2.Zero, scale, SpriteEffects.None, 0f);
            }
        }
    }
}
