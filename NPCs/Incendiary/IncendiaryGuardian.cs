    ...
    class IncendiaryGuardian : ModNPC
    {
        ...
        public override void PostDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            if (frame == 4 && fireCounter > 0)
            {
                ...
                {
                    Terraria.Utils.DrawLine(spriteBatch, NPC.Center + new Vector2(0, -15), NPC.Center + new Vector2(0, -15) + rotation.ToRotationVector2().RotatedBy(MathHelper.ToRadians(360 / laserCount) * i) * 100, Color.Red, Color.Transparent, 5);
                }
            }
        }
